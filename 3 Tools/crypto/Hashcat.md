...
| Option             | Purpose                                                                                                                                                                                                                                |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `-b`               | benchmark the present hardware & compare the hash rate with no. of possible combinations - see [[1 Methods/Security-Testing/3 Initial Access/Password Attacks#Time Estimation\|Bruteforce and Dictionary Attacks]] |
