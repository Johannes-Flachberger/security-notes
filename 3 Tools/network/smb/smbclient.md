...
connect to [[2 Tech-Specifics/Network/Protocols/SMB|SMB]] shares
...
| Option                  | Purpose                                                                                                          |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `--pw-nt-hash <hash>`   | authenticate using NLTM hash - see [[2 Tech-Specifics/OS/Windows/Lateral Movement - Windows/Pass the Hash\|Pass the Hash]] |
| `-U <user>`             | User                                                                                                             |
