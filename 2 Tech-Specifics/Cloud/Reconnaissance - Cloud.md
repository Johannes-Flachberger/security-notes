...
- [ ] Perform [[2 Tech-Specifics/Network/Protocols/DNS#Enumeration|DNS Enumeration]] and [[2 Tech-Specifics/Web/Enumeration - Web/Subdomain Enumeration|Subdomain Enumeration]]
...
- [ ] For web-pages: [[2 Tech-Specifics/Web/Enumeration - Web/Overview - Enumeration - Web#Debugging Page Content|Overview - WebApp Enumeration]]
...
- [[2 Tech-Specifics/Cloud/AWS/Reconnaissance - AWS#Find public cloud ressources|AWS Enumeration]]

## Enumerate resources for attack vectors

**See:**

- [[2 Tech-Specifics/Cloud/AWS/Reconnaissance - AWS|Reconnaissance - AWS]]
