...
- See [[2 Tech-Specifics/Cloud/Reconnaissance - Cloud|Reconnaissance - Cloud]]
...
2. Create a [[2 Tech-Specifics/Cloud/AWS/Fundamentals - AWS#IAM Policies|IAM Policy]] that grants a the target IAM user of the known target AWS account access to the resource
	- Note: IAM identities are identified using [[2 Tech-Specifics/Cloud/AWS/Fundamentals - AWS#AWS Resource Name (ARN)|ARNs]]
