...
| Get integrity level of current process                                                                                                                                  | use [Process Explorer](https://learn.microsoft.com/en-us/sysinternals/downloads/process-explorer)<br>use third party powershell modules: [NtObjectManager](https://www.powershellgallery.com/packages/NtObjectManager/1.1.33) --> `Get-NtTokenIntegrityLevel`<br> |
