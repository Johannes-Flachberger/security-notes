...
cmd basics in [[2 Tech-Specifics/OS/Windows/cmd]]
## enumerate users
...
| `wmic product get name,version,vendor` | show product info, only specific parts (above commands may not show all software due to backwards compatibility issues) |
