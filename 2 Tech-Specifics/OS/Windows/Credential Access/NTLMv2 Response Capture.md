...
2. Use the hash for further attacks - e.g:
	...
	- Relay the handshake: [[2 Tech-Specifics/OS/Windows/Lateral Movement/NTLMv2 Relay Attack|NTLMv2 Relay Attack]]
	- Create a Kerberos TGT: [[2 Tech-Specifics/Active Directory/Credential Access/Overpass the Hash|Overpass the Hash]]
