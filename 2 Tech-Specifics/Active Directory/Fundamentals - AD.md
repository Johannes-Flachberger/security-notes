...
Using this feature, a domain controller can be "impersonated" and credentials can be accessed - see [[2 Tech-Specifics/Active Directory/Lateral Movement - AD/dcsync|dcsync]]
