...
Windows remote management tool - basically [[2 Tech-Specifics/_Other/File Formats/XML|XML]] over [[2 Tech-Specifics/Network/Protocols/TCP 80,443 HTTP(S)|HTTP(S)]].
...
- [evil-winrm](https://github.com/Hackplayers/evil-winrm):
	...
	- supports [[2 Tech-Specifics/OS/Windows/Lateral Movement/Pass the Hash|Pass the Hash]]
