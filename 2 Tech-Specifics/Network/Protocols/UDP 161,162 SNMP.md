...
- [[2 Tech-Specifics/Network/Protocols/Fundamentals/UDP 161,162 SNMP Fundamentals#4️. SNMP Versions|SNMPv3]] supports encryption, message integrity and authentication - old versions only supported DES-56, which can be brute forced
