...
- use [ActiveX Objects](https://learn.microsoft.com/en-us/previous-versions/windows/desktop/automat/activex-objects) to issue system commandse.g. `CreateObject("Wscript.Shell").Run "powershell"`
...
From the macro, e.g. pop a [[1 Methods/Security-Testing/12 Command and Control/Remote Shells|Remote Shell]] or a e.g. using [[3 Tools/shells/powercat|powercat]] or [[3 Tools/shells/PowerShell#Reverse Shell Payloads|PowerShell]]
